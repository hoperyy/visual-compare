(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		var a = factory();
		(typeof exports === 'object' ? exports : root)['VisualCompare'] = a;
	}
})(this, function() {
...
var $ = __webpack_require__(0);
var Drag = __webpack_require__(4);
var Img = __webpack_require__(7);
var CrossLine = __webpack_require__(6);
...
$.extend(Panel.prototype, {
    ...
    appendDom: function () {
        ...
        var domString = '' + '<div class="visual-compare-panel J_VisualComparePanel" style="z-index: ' + panelZIndex + ';">' + '<div class="visual-compare-panel-area J_VisualCompare_PanelArea"' + (!this.config.showPanel ? ' style="display: none;"' : '') + '>' + '<ul>' + '<li>' + '<span class="label">opacity: </span><input type="text" value="' + this.config.opacity + '" class="J_VisualCompare_InputText J_VisualCompare_ValOpacity">' + '</li>' + '<li>' + '<span class="label">z-index: </span><input type="text" value="' + this.config.zIndex + '" class="J_VisualCompare_InputText J_VisualCompare_ValZIndex">' + '</li>' + '<li>' + '<span class="label">width: </span><input type="text" value="' + this.config.width + '" class="J_VisualCompare_InputText J_VisualCompare_ValWidth">' + '</li>' + '<li>' + '<span class="label">height: </span><input type="text" value="' + this.config.height + '" class="J_VisualCompare_InputText J_VisualCompare_ValHeight">' + '</li>' + '<li>' + '<span class="label">left: </span><input type="text" value="' + this.config.left + '" class="J_VisualCompare_InputText J_VisualCompare_ValLeft">' + '</li>' + '<li>' + '<span class="label">top: </span><input type="text" value="' + this.config.top + '" class="J_VisualCompare_InputText J_VisualCompare_ValTop">' + '</li>' + '<li>' + '<span class="label">img src: </span><input type="text"' + (this.config.src ? 'value=' + this.config.src : '') + ' class="J_VisualCompare_InputText J_VisualCompare_ValPic">' + '</li>' + '<li>' + '<span class="label">img border: </span><span class="checkbox J_VisualCompare_InputCheckbox J_VisualCompare_ValBorder' + (this.config.showBorder ? ' checked' : '') + '"></span>' + '</li>' + '<li>' + '<span class="label">crossline: </span><span class="checkbox J_VisualCompare_InputCheckbox J_VisualCompare_ValCrossLine' + (this.config.showCrossLine ? ' checked' : '') + '"></span>' + '</li>' + '</ul>' + '</div>' + '<div class="visual-compare-btn-area">' + '<a href="javascript:;"' + (!this.config.showPanel ? ' style="display: none;"' : '') + ' class="visual-compare-btn btn-reset J_VisualCompare_Reset">重置</a>' + (this.config.showImg && this.config.src ? '<a href="javascript:;"' + (!this.config.showPanel ? ' style="display: none;"' : '') + ' class="visual-compare-btn btn-img-switcher J_VisualCompare_ImgSwither">隐藏图片</a>' : '<a href="javascript:;"' + (!this.config.showPanel ? ' style="display: none;"' : '') + ' class="visual-compare-btn btn-img-switcher visual-compare-is-closed J_VisualCompare_ImgSwither">显示图片</a>') + (this.config.showPanel ? '<a href="javascript:;" class="visual-compare-btn J_VisualCompare_PanelSwitcher">收起面板<a>' : '<a href="javascript:;" class="visual-compare-btn J_VisualCompare_PanelSwitcher visual-compare-is-closed' + '">还原度助手</a>') + '</div>' + '</div>';
    ...
    addEvent: function () {
        ...
        this.$container.find('.J_VisualCompare_PanelSwitcher').on('click touchstart', function (ev) {
            ...
            if ($target.hasClass('visual-compare-is-closed')) {
                // 关闭状态
                self.$panelArea.show();
...
// module
exports.push([module.i, "html body .visual-compare-wrapper {\n  position: relative;\n}\n", ""]);
...
// module
exports.push([module.i, "/*交叉线部分*/\nhtml body .visual-compare-row-line,\nhtml body .visual-compare-vertical-line {\n  display: none;\n  position: fixed;\n  z-index: 1000;\n  left: 0;\n  top: 0;\n  background: red;\n}\nhtml body .visual-compare-row-line.visual-compare-show,\nhtml body .visual-compare-vertical-line.visual-compare-show {\n  display: block;\n}\nhtml body .visual-compare-row-line {\n  left: 0;\n  right: 0;\n  height: 1px;\n}\nhtml body .visual-compare-vertical-line {\n  width: 1px;\n  top: 0;\n  bottom: 0;\n}\n", ""]);
...
// module
exports.push([module.i, "/*图片部分*/\nhtml body .visual-compare-img {\n  box-sizing: border-box;\n  position: fixed;\n  width: 100%;\n  opacity: .5;\n  cursor: move;\n}\nhtml body .visual-compare-img.visual-compare-show {\n  display: inline;\n}\n", ""]);
...
// module
exports.push([module.i, "html body .visual-compare-panel {\n  box-sizing: border-box;\n  position: fixed;\n  z-index: 1000;\n  right: 0;\n  bottom: 0;\n  background: #ffffff;\n  border: 1px solid black;\n}\nhtml body .visual-compare-panel ul,\nhtml body .visual-compare-panel li {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n}\nhtml body .visual-compare-panel .visual-compare-panel-area {\n  padding-right: 10px;\n  padding-bottom: 10px;\n}\nhtml body .visual-compare-panel .visual-compare-panel-area ul {\n  padding-top: 10px;\n}\nhtml body .visual-compare-panel .visual-compare-panel-area li {\n  line-height: 26px;\n  height: 26px;\n  font-size: 12px;\n}\nhtml body .visual-compare-panel .visual-compare-panel-area li:after {\n  display: block;\n  content: \" \";\n  clear: both;\n}\nhtml body .visual-compare-panel .visual-compare-panel-area .label {\n  padding: 0;\n  margin: 0;\n  background: #fff;\n  line-height: 26px;\n  text-transform: none;\n  float: left;\n  width: 80px;\n  height: 26px;\n  vertical-align: middle;\n  padding-right: 10px;\n  text-align: right;\n  color: #000;\n  font-size: 12px;\n  font-weight: normal;\n}\nhtml body .visual-compare-panel .visual-compare-panel-area input[type=\"text\"] {\n  box-sizing: border-box;\n  height: 26px;\n  border-radius: 0;\n  box-shadow: none;\n  margin: 0;\n  width: 140px;\n  border-top: 0;\n  border-left: 0;\n  border-right: 0;\n  border-bottom: 1px solid black;\n  vertical-align: middle;\n  outline: none;\n  font-size: 12px;\n}\nhtml body .visual-compare-panel .visual-compare-panel-area .checkbox {\n  float: left;\n  margin-top: 7px;\n  width: 12px;\n  height: 12px;\n  border: 1px solid #000;\n}\nhtml body .visual-compare-panel .visual-compare-panel-area .checkbox.checked {\n  background: rgba(127, 220, 127, 0.79);\n}\nhtml body .visual-compare-panel .visual-compare-btn-area {\n  position: relative;\n  text-align: right;\n}\nhtml body .visual-compare-panel .visual-compare-btn-area .visual-compare-btn-upload-wrap {\n  margin-bottom: 10px;\n}\nhtml body .visual-compare-panel .visual-compare-btn-area .visual-compare-btn-img-upload {\n  border: 1px solid black;\n}\nhtml body .visual-compare-panel .visual-compare-btn-area .visual-compare-btn {\n  display: inline-block;\n  padding: 5px;\n  text-align: center;\n  margin: 0 5px;\n  color: #000;\n  font-size: 12px;\n  text-decoration: none;\n}\n", ""]);
